...
const Posts = (props) => {
    ...
    return (
        <div className={mainPostsCSS.wrapper__box}>
            <div className={mainPostsCSS.box__separation}>
                <div className={mainPostsCSS.box__separation_media}>
                    <div className={mainPostsCSS.info__whole_name}>
                        <div className={mainPostsCSS.info__name}> {item.name} </div>
                        <div className={mainPostsCSS.info__nickname}> {item.nickname} </div>
                    </div>
                    <div className={mainPostsCSS.media__photo}> {item.photo} </div>
                    <div className={mainPostsCSS.media__community}><span className={mainPostsCSS.forum__head}>Community: </span>
                        <span className={mainPostsCSS.media__forum}>{item.forum} </span>
                    </div>
                    <div className={mainPostsCSS.media__subscribers}>
                        <div className={mainPostsCSS.media__subscribers_image}>
                        ...
                        <div className={mainPostsCSS.media__subscribers_info}>
                            <div> {item.getSubscribers()} </div>
                        </div>
                    </div>
                </div>
                <div className={mainPostsCSS.box__separation_info}>
                    <div className={mainPostsCSS.info__date}> {item.getDate()} </div>
                    <div className={mainPostsCSS.info__image}> {item.image} </div>
                    <div className={mainPostsCSS.info__quote}> {item.quote} </div>
                    <div className={mainPostsCSS.info__panel}>
                        <div className={mainPostsCSS.info__tags}>
                            <div className={mainPostsCSS.info__tags_item1}>
                                {item.tag1}
                            </div>
                            <div className={mainPostsCSS.info__tags_item2}>
                                {item.tag2}
                            </div>
                        </div>
                        <div className={mainPostsCSS.info__likes}>
                            <div className={mainPostsCSS.info__likes_image}>
                                <svg className={mainPostsCSS.info__likes_image_item}>
